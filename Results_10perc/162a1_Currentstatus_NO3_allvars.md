---
title: "162a1 Analyse NO3 medians 2012-2016 - all variables"
author: "DHJ"
date: "8 5 2020"
output: 
  html_document:
...
![](162a1_Currentstatus_NO3_allvars_files/figure-html/unnamed-chunk-14-1.png)<!-- -->
...
![](162a1_Currentstatus_NO3_allvars_files/figure-html/unnamed-chunk-16-1.png)<!-- -->
...
![](162a1_Currentstatus_NO3_allvars_files/figure-html/unnamed-chunk-18-1.png)<!-- -->
...
## |   |   [3] tmp <= 4.04167
## |   |   |   [4] slope_dep_vs_time <= -3.30284
## |   |   |   |   [5] log_median_toc <= 0.17609: 1.638 (n = 8, err = 0.4)
## |   |   |   |   [6] log_median_toc > 0.17609
## |   |   |   |   |   [7] urban <= 1.562: 1.038 (n = 67, err = 6.2)
## |   |   |   |   |   [8] urban > 1.562: 1.564 (n = 8, err = 1.3)
## |   |   |   [9] slope_dep_vs_time > -3.30284: 0.580 (n = 23, err = 2.7)
## |   |   [10] tmp > 4.04167
## |   |   |   [11] wetland <= 20.632
## |   |   |   |   [12] slope_dep_vs_time <= -13.20993: 1.536 (n = 77, err = 9.7)
## |   |   |   |   [13] slope_dep_vs_time > -13.20993: 1.267 (n = 75, err = 1.4)
## |   |   |   [14] wetland > 20.632: 2.369 (n = 8, err = 0.1)
## |   [15] TOTN_dep > 794.88144
## |   |   [16] log_median_toc <= 0.58878
## |   |   |   [17] TOTN_dep <= 1231.58
## |   |   |   |   [18] bare_sparse <= 47.412: 2.111 (n = 24, err = 1.5)
## |   |   |   |   [19] bare_sparse > 47.412: 2.420 (n = 13, err = 0.2)
## |   |   |   [20] TOTN_dep > 1231.58: 2.623 (n = 7, err = 0.4)
## |   |   [21] log_median_toc > 0.58878
## |   |   |   [22] tmp <= 7.49167: 1.584 (n = 34, err = 5.2)
## |   |   |   [23] tmp > 7.49167: 2.091 (n = 29, err = 7.5)
## 
...
![](162a1_Currentstatus_NO3_allvars_files/figure-html/unnamed-chunk-19-1.png)<!-- -->
...
## 
##           Mean of squared residuals: 0.1067012
##                     % Var explained: 66.83
```
...
![](162a1_Currentstatus_NO3_allvars_files/figure-html/unnamed-chunk-21-1.png)<!-- -->
...
![](162a1_Currentstatus_NO3_allvars_files/figure-html/unnamed-chunk-21-2.png)<!-- -->
...
![](162a1_Currentstatus_NO3_allvars_files/figure-html/5c3_plot_partial_effects2-1.png)<!-- -->![](162a1_Currentstatus_NO3_allvars_files/figure-html/5c3_plot_partial_effects2-2.png)<!-- -->![](162a1_Currentstatus_NO3_allvars_files/figure-html/5c3_plot_partial_effects2-3.png)<!-- -->![](162a1_Currentstatus_NO3_allvars_files/figure-html/5c3_plot_partial_effects2-4.png)<!-- -->![](162a1_Currentstatus_NO3_allvars_files/figure-html/5c3_plot_partial_effects2-5.png)<!-- -->![](162a1_Currentstatus_NO3_allvars_files/figure-html/5c3_plot_partial_effects2-6.png)<!-- -->![](162a1_Currentstatus_NO3_allvars_files/figure-html/5c3_plot_partial_effects2-7.png)<!-- -->![](162a1_Currentstatus_NO3_allvars_files/figure-html/5c3_plot_partial_effects2-8.png)<!-- -->
...
## 16256 1.391 0.000138 -0.004716 0.0002919 -0.007781 -0.008289 -0.011550    -0.01577
## 16253 1.196                    0.0002773 -0.005899 -0.006440 -0.009526     0.05069
## 16255 1.414          -0.003015 0.0002769 -0.007549 -0.008079 -0.011640    -0.01917
##       slp_dep_vs_tim     tmp ttl_shr_hrb  TOT_dep log_mdn_toc:TOT_dep slp_dep_vs_tim:TOT_dep
## 16256      -0.006917 0.05605   -0.008684 0.001065          -0.0003496              6.352e-06
## 16253      -0.006725 0.04919   -0.006631 0.001170          -0.0003888              6.852e-06
## 16255      -0.007015 0.04634   -0.008470 0.001186          -0.0003741              7.133e-06
##       df   logLik  AICc delta weight
## 16256 15 -131.814 295.0  0.00  0.558
## 16253 13 -134.876 296.8  1.79  0.228
## 16255 14 -133.860 296.9  1.92  0.214
...
![](162a1_Currentstatus_NO3_allvars_files/figure-html/unnamed-chunk-25-1.png)<!-- -->![](162a1_Currentstatus_NO3_allvars_files/figure-html/unnamed-chunk-25-2.png)<!-- -->
...
![](162a1_Currentstatus_NO3_allvars_files/figure-html/unnamed-chunk-25-3.png)<!-- -->![](162a1_Currentstatus_NO3_allvars_files/figure-html/unnamed-chunk-25-4.png)<!-- -->

```
## Conditions used in construction of plot
## bare_sparse: 0
## catchment_area: 3.461
## coniferous: 16.578
## decid_mixed: 9.989
## lake_water: 11.99
## log_median_toc: 0.7589119
## slope_dep_vs_time: -13.52158
## tmp: 5.425001
## total_shrub_herbaceous: 2.96855
## TOTN_dep: 532.4
## Conditions used in construction of plot
## altitude: 216
## catchment_area: 3.461
