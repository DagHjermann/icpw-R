...
##                      0                      0                      0                      0 
##                 region              continent         log_median_no3      slope_dep_vs_time 
##                      0                      0                      0                      0 
...
## |   [2] TOTN_dep <= 710.95
## |   |   [3] tmp <= 8.24167
## |   |   |   [4] slope_dep_vs_time <= -2.5575
## |   |   |   |   [5] bare_sparse <= 0.003: 1.075 (n = 169, err = 48.1)
## |   |   |   |   [6] bare_sparse > 0.003
## |   |   |   |   |   [7] slope_dep_vs_time <= -10.50278: 1.598 (n = 41, err = 5.1)
## |   |   |   |   |   [8] slope_dep_vs_time > -10.50278: 1.144 (n = 31, err = 3.3)
## |   |   |   [9] slope_dep_vs_time > -2.5575: 0.413 (n = 19, err = 1.2)
## |   |   [10] tmp > 8.24167: 2.369 (n = 8, err = 0.1)
## |   [11] TOTN_dep > 710.95
## |   |   [12] bare_sparse <= 4.895: 1.847 (n = 153, err = 61.9)
## |   |   [13] bare_sparse > 4.895
## |   |   |   [14] lake_water <= 2.836: 2.608 (n = 8, err = 0.1)
## |   |   |   [15] lake_water > 2.836
## |   |   |   |   [16] bare_sparse <= 47.412: 2.107 (n = 12, err = 0.5)
## |   |   |   |   [17] bare_sparse > 47.412: 2.373 (n = 11, err = 0.1)
## 
...
## 
##           Mean of squared residuals: 0.2041591
##                     % Var explained: 58.88
```
...
## 1014 1.308 0.0001548          -0.01491                 -0.01223 0.05288 -0.007546   -0.006685
## 1016 1.499 0.0002116 -0.00358 -0.01670                 -0.01259 0.05224 -0.009692   -0.008601
## 1013 1.489                    -0.01636                 -0.01334 0.03556 -0.009082   -0.007949
## 1022 1.275 0.0001424          -0.01486 4.289e-05       -0.01227 0.04843 -0.007504   -0.006877
## 1024 1.474 0.0002012 -0.00393 -0.01681 5.553e-05       -0.01267 0.04641 -0.009848   -0.009037
##        TOT_dep slp_dep_vs_tim:TOT_dep df   logLik  AICc delta weight
## 1014 0.0006522              6.260e-06 10 -360.577 741.7  0.00  0.323
## 1016 0.0006249              6.121e-06 11 -359.782 742.2  0.51  0.250
## 1013 0.0008155              7.790e-06  9 -362.318 743.0  1.39  0.161
## 1022 0.0006757              6.395e-06 11 -360.354 743.3  1.65  0.141
## 1024 0.0006526              6.283e-06 12 -359.414 743.5  1.89  0.126
