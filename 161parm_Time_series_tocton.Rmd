...
writexl::write_xlsx(df_analysis_allrows, fn)
cat("Dataset after removing urban, cultivated, AtlCan and Italy saved as", sQuote(fn), "\n\n")
...
cat("\n\n")
cat("Data before removing AtlCan and Italy: n =", nrow(dat), "\n")
