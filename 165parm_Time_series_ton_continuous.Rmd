...
#
# This file is designed to be run using '165parm_run_markdown.R'  
...
dat_1 <- dat_1_all %>%
  filter(!is.na(slope_ton_vs_time))
...
# saveRDS(dd1b, "Data/165_all_dd1b.rds")    # save it as it takes a couple of minutes
# # dd1b <- readRDS("Data/165_all_dd1b.rds")
# 
# # subset(dd1b, delta < 1)
# subset(dd1b, delta < 2)
# 
