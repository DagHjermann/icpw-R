...
params:
  ...
  selected_vars: 
    value: 'catchment_area, slope_dep_vs_time, TOTN_dep, slope_tocton_vs_time, TOCTON, slope_pre, pre, slope_tmp, tmp, urban, cultivated, coniferous, decid_mixed, total_shrub_herbaceous,wetland, lake_water, bare_sparse, slope_toc_vs_time, TOC, slope_ton_vs_time, TON'
...
#
# This file is designed to be run using '167parm_run_markdown.R'  
...
# #   no3_decline ~ as.formula(params$regression_formula),
# 
# fm <- glm(
...
# saveRDS(dd1b, "Data/167_all_dd1b.rds")    # save it as it takes a couple of minutes
# # dd1b <- readRDS("Data/167_all_dd1b.rds")
# 
# # subset(dd1b, delta < 1)
# subset(dd1b, delta < 2)
# 
