...
### Extra UK data - add to df_landcover1   
* Creating 'df_landcover2'   
...
df_landcover3 <- bind_rows(
  ...
  df_landcover_uk2[c("station_id", vars_landcover)],
)
...
df_meta1 <- df_meta_without_landcover %>% 
  left_join(df_landcover3, by = "station_id")
...
# Order columns
df_meta1 <- df_meta1[c(names(df_meta1), vars_landcover)]
...
writexl::write_xlsx(df_meta1, "Data/159_df_meta1_including_UK.xlsx")
