...
## |   |   [8] log_median_toc <= 0.79934
## |   |   |   [9] log_median_toc <= 0.34242: 1.248 (n = 19, err = 0.2)
## |   |   |   [10] log_median_toc > 0.34242
## |   |   |   |   [11] log_median_ton <= 2.17898
## |   |   |   |   |   [12] lake_water <= 19.19582: 1.482 (n = 19, err = 0.2)
## |   |   |   |   |   [13] lake_water > 19.19582: 1.329 (n = 7, err = 0.0)
## |   |   |   |   [14] log_median_ton > 2.17898
## |   |   |   |   |   [15] log_median_toc <= 0.60477: 1.253 (n = 25, err = 0.1)
## |   |   |   |   |   [16] log_median_toc > 0.60477
## |   |   |   |   |   |   [17] log_median_ton <= 2.30103: 1.432 (n = 18, err = 0.1)
## |   |   |   |   |   |   [18] log_median_ton > 2.30103: 1.336 (n = 26, err = 0.1)
## |   |   [19] log_median_toc > 0.79934
## |   |   |   [20] slope_dep_vs_time <= -18.8471
## |   |   |   |   [21] decid_mixed <= 19.529
## |   |   |   |   |   [22] log_median_toc <= 0.93952
## |   |   |   |   |   |   [23] log_median_ton <= 2.48412: 1.438 (n = 12, err = 0.0)
## |   |   |   |   |   |   [24] log_median_ton > 2.48412: 1.357 (n = 8, err = 0.0)
## |   |   |   |   |   [25] log_median_toc > 0.93952: 1.497 (n = 43, err = 0.3)
## |   |   |   |   [26] decid_mixed > 19.529: 1.343 (n = 12, err = 0.1)
## |   |   |   [27] slope_dep_vs_time > -18.8471
## |   |   |   |   [28] log_median_toc <= 0.94448
## |   |   |   |   |   [29] log_median_ton <= 2.41747: 1.505 (n = 19, err = 0.0)
## |   |   |   |   |   [30] log_median_ton > 2.41747: 1.419 (n = 7, err = 0.0)
## |   |   |   |   [31] log_median_toc > 0.94448
## |   |   |   |   |   [32] wetland <= 6.50778
## |   |   |   |   |   |   [33] coniferous <= 18.50211: 1.610 (n = 15, err = 0.0)
## |   |   |   |   |   |   [34] coniferous > 18.50211: 1.523 (n = 16, err = 0.0)
## |   |   |   |   |   [35] wetland > 6.50778: 1.628 (n = 16, err = 0.1)
## 
...
## 
##           Mean of squared residuals: 0.007352986
##                     % Var explained: 81.98
```
...
## 1987 2.865            -0.0003299                                    0.9820     -0.9327
## 4033 2.823                                                          1.0470     -0.9156
## 1986 2.864 -1.479e-05                                               0.9850     -0.9319
## 2003 2.864            -0.0003726                    -8.908e-05      0.9818     -0.9319
## 4034 2.827 -1.176e-05                                               1.0330     -0.9141
## 963  2.875            -0.0003129                                    0.9860     -0.9392
## 1985 2.868                                                          0.9924     -0.9382
## 1988 2.863 -8.808e-06 -0.0002622                                    0.9797     -0.9301
## 4035 2.841            -0.0002321                                    1.0150     -0.9219
## 3009 2.833                                                          1.0500     -0.9216
## 1995 2.865            -0.0003371          5.297e-05                 0.9805     -0.9335
## 979  2.872            -0.0003730                    -1.204e-04      0.9852     -0.9372
## 1991 2.863            -0.0003329 7.44e-06                           0.9814     -0.9320
## 4049 2.817                                          -8.016e-05      1.0540     -0.9129
##            pre       tmp       urb log_mdn_toc:log_mdn_ton df  logLik    AICc delta weight
## 1987 1.323e-05 -0.003760 -0.002683                          8 569.747 -1123.0  0.00  0.135
## 4033 1.157e-05 -0.003442 -0.002554                -0.02628  8 569.469 -1122.4  0.56  0.102
## 1986 1.286e-05 -0.003739 -0.002999                          8 569.175 -1121.9  1.14  0.076
## 2003 1.500e-05 -0.003899 -0.002396                          9 570.205 -1121.8  1.21  0.074
## 4034 1.244e-05 -0.003690 -0.002915                -0.02221  9 570.193 -1121.8  1.23  0.073
## 963  1.507e-05 -0.004298                                    7 567.998 -1121.6  1.39  0.067
## 1985 1.181e-05 -0.003423 -0.002543                          7 567.983 -1121.6  1.42  0.066
## 1988 1.356e-05 -0.003879 -0.002926                          9 570.099 -1121.6  1.42  0.066
## 4035 1.267e-05 -0.003670 -0.002647                -0.01448  9 570.046 -1121.5  1.53  0.063
## 3009 1.340e-05 -0.003972                          -0.02616  7 567.881 -1121.4  1.62  0.060
## 1995 1.456e-05 -0.003827 -0.002628                          9 569.936 -1121.2  1.75  0.056
## 979  1.720e-05 -0.004408                                    8 568.862 -1121.2  1.77  0.056
## 1991 1.327e-05 -0.003730 -0.002759                          9 569.913 -1121.2  1.79  0.055
## 4049 1.297e-05 -0.003530 -0.002282                -0.02927  9 569.844 -1121.1  1.93  0.051
