---
title: "162ab1 Analyse NO3 medians 2012-2016 - not area"
author: "DHJ"
date: "8 5 2020"
output: 
  html_document:
...
![](162ab1_Currentstatus_NO3_allvars_files/figure-html/unnamed-chunk-15-1.png)<!-- -->
...
## -------------------------------------------------------------
## Variables: 
## log_median_no3,log_median_toc,slope_dep_vs_time, TOTN_dep, latitude, longitude, altitude,pre, tmp, urban, cultivated, coniferous, decid_mixed, total_shrub_herbaceous,wetland, lake_water, bare_sparse
## -------------------------------------------------------------
...
![](162ab1_Currentstatus_NO3_allvars_files/figure-html/unnamed-chunk-17-1.png)<!-- -->
...
![](162ab1_Currentstatus_NO3_allvars_files/figure-html/unnamed-chunk-19-1.png)<!-- -->

```
## 
## Model formula:
## log_median_no3 ~ log_median_toc + slope_dep_vs_time + TOTN_dep + 
...
## |   |   [3] tmp <= 8.24167
## |   |   |   [4] urban <= 0.001
## |   |   |   |   [5] pre <= 1229.80005: 0.783 (n = 99, err = 38.3)
## |   |   |   |   [6] pre > 1229.80005
## |   |   |   |   |   [7] slope_dep_vs_time <= -7.73529
## |   |   |   |   |   |   [8] bare_sparse <= 7.274: 1.299 (n = 22, err = 0.2)
## |   |   |   |   |   |   [9] bare_sparse > 7.274: 1.573 (n = 7, err = 0.3)
## |   |   |   |   |   [10] slope_dep_vs_time > -7.73529
## |   |   |   |   |   |   [11] lake_water <= 8.504: 0.816 (n = 7, err = 0.3)
## |   |   |   |   |   |   [12] lake_water > 8.504: 1.223 (n = 24, err = 1.1)
## |   |   |   [13] urban > 0.001
## |   |   |   |   [14] slope_dep_vs_time <= -13.20993: 1.546 (n = 43, err = 4.0)
## |   |   |   |   [15] slope_dep_vs_time > -13.20993: 1.265 (n = 47, err = 3.1)
## |   |   [16] tmp > 8.24167: 2.369 (n = 8, err = 0.1)
## |   [17] TOTN_dep > 710.95
## |   |   [18] log_median_toc <= 0.99564
## |   |   |   [19] log_median_toc <= 0.30103
## |   |   |   |   [20] lake_water <= 5.052: 2.463 (n = 13, err = 0.6)
## |   |   |   |   [21] lake_water > 5.052: 2.209 (n = 18, err = 0.6)
## |   |   |   [22] log_median_toc > 0.30103: 1.930 (n = 114, err = 34.3)
## |   |   [23] log_median_toc > 0.99564
## |   |   |   [24] tmp <= 6.68333: 0.683 (n = 8, err = 8.6)
## |   |   |   [25] tmp > 6.68333: 1.660 (n = 21, err = 3.1)
## 
...
![](162ab1_Currentstatus_NO3_allvars_files/figure-html/unnamed-chunk-20-1.png)<!-- -->
...
## 
##           Mean of squared residuals: 0.2038779
##                     % Var explained: 57.67
```
...
![](162ab1_Currentstatus_NO3_allvars_files/figure-html/unnamed-chunk-22-1.png)<!-- -->
...
![](162ab1_Currentstatus_NO3_allvars_files/figure-html/unnamed-chunk-22-2.png)<!-- -->
...
## 1                TOTN_dep       1.210000        7279  0.340807446            50.273630
## 2       slope_dep_vs_time       1.918000        7312  0.221115126            28.950589
## 3                     tmp       2.054000        5827  0.239847148            25.975912
## 4                altitude       2.712000        6822  0.049870167            14.234887
## 5              lake_water       2.928000        6174  0.034555603            11.157658
## 6                     pre       3.016000        5558  0.071176495            12.791178
## 7                 wetland       3.170000        5188  0.037597086            10.705263
## 8             decid_mixed       3.794000        5125  0.033373282             7.695754
## 9          log_median_toc       2.594000        6638  0.075942406            12.495321
## 10             coniferous       3.406000        5196  0.045839847             9.212643
## 11            bare_sparse       4.569864        2517  0.014952226             2.808195
## 12             cultivated       6.591784        1281  0.004459604             1.433815
## 13 total_shrub_herbaceous       3.868000        4956  0.015314729             5.858483
## 14                  urban       4.682912        2023  0.027642958             5.270951
##    no_of_trees times_a_root       p_value
## 1          500          184 1.959929e-189
## 2          500          122 6.075195e-195
## 3          500           70  4.927968e-23
## 4          500           39 1.060896e-120
## 5          500           37  1.338061e-48
## 6          500           18  7.732657e-10
## 7          500           16  2.251397e-01
## 8          500            7  5.620784e-01
## 9          500            4  4.046851e-97
## 10         500            3  1.920378e-01
## 11         499            0  1.000000e+00
## 12         469            0  1.000000e+00
## 13         500            0  9.955745e-01
## 14         492            0  1.000000e+00
```
...
![](162ab1_Currentstatus_NO3_allvars_files/figure-html/5c3_plot_partial_effects2-1.png)<!-- -->![](162ab1_Currentstatus_NO3_allvars_files/figure-html/5c3_plot_partial_effects2-2.png)<!-- -->![](162ab1_Currentstatus_NO3_allvars_files/figure-html/5c3_plot_partial_effects2-3.png)<!-- -->![](162ab1_Currentstatus_NO3_allvars_files/figure-html/5c3_plot_partial_effects2-4.png)<!-- -->![](162ab1_Currentstatus_NO3_allvars_files/figure-html/5c3_plot_partial_effects2-5.png)<!-- -->![](162ab1_Currentstatus_NO3_allvars_files/figure-html/5c3_plot_partial_effects2-6.png)<!-- -->![](162ab1_Currentstatus_NO3_allvars_files/figure-html/5c3_plot_partial_effects2-7.png)<!-- -->![](162ab1_Currentstatus_NO3_allvars_files/figure-html/5c3_plot_partial_effects2-8.png)<!-- -->
...
##      (Int)       alt   bar_spr       cnf   dcd_mxd  lak_wtr log_mdn_toc slp_dep_vs_tim     tmp
## 8128 1.665 0.0001628 -0.007118 -0.009518 -0.010630 -0.01739    -0.06573      -0.009086 0.05774
## 8127 1.699           -0.005328 -0.009464 -0.010480 -0.01750    -0.06892      -0.009378 0.04435
## 8125 1.326                     -0.006693 -0.007461 -0.01410     0.04665      -0.008987 0.04710
## 3904 1.686 0.0002231 -0.007415 -0.008597 -0.010430 -0.01853    -0.04420                0.07133
##      ttl_shr_hrb   TOT_dep log_mdn_toc:TOT_dep slp_dep_vs_tim:TOT_dep df   logLik  AICc delta
## 8128   -0.010350 0.0008672          -0.0003768              4.538e-06 14 -339.346 707.7  0.00
## 8127   -0.010270 0.0010420          -0.0004047              5.769e-06 13 -340.595 708.1  0.36
## 8125   -0.007233 0.0010440          -0.0004214              5.614e-06 12 -342.191 709.1  1.43
## 3904   -0.010370 0.0008215          -0.0004403                        12 -342.212 709.2  1.47
##      weight
## 8128  0.357
## 8127  0.297
## 8125  0.175
...
![](162ab1_Currentstatus_NO3_allvars_files/figure-html/unnamed-chunk-26-1.png)<!-- -->![](162ab1_Currentstatus_NO3_allvars_files/figure-html/unnamed-chunk-26-2.png)<!-- -->
...
![](162ab1_Currentstatus_NO3_allvars_files/figure-html/unnamed-chunk-26-3.png)<!-- -->![](162ab1_Currentstatus_NO3_allvars_files/figure-html/unnamed-chunk-26-4.png)<!-- -->
