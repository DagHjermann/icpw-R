...
![](162a2_Currentstatus_NO3_allvars_files/figure-html/unnamed-chunk-18-1.png)<!-- -->
...
## |   |   |   |   |   |   [10] cultivated <= 0.62: 1.426 (n = 66, err = 8.1)
## |   |   |   |   |   |   [11] cultivated > 0.62: 1.739 (n = 17, err = 0.7)
## |   |   |   |   |   [12] bare_sparse > 31.921: 2.031 (n = 7, err = 0.3)
## |   |   |   |   [13] slope_dep_vs_time > -13.20993: 1.235 (n = 104, err = 6.3)
## |   |   |   [14] wetland > 21.807: 2.369 (n = 8, err = 0.1)
## |   [15] TOTN_dep > 794.88144
## |   |   [16] log_median_toc <= 0.58878
## |   |   |   [17] log_median_toc <= 0.11394
## |   |   |   |   [18] total_forest <= 2.404: 2.404 (n = 18, err = 0.4)
## |   |   |   |   [19] total_forest > 2.404: 2.650 (n = 7, err = 0.3)
## |   |   |   [20] log_median_toc > 0.11394: 2.144 (n = 24, err = 2.1)
...
## 
##           Mean of squared residuals: 0.1037032
##                     % Var explained: 70.06
```
...
![](162a2_Currentstatus_NO3_allvars_files/figure-html/unnamed-chunk-21-1.png)<!-- -->
...
## 8160 1.419 1.051e-04 -0.00462 0.0002985 -0.012720    -0.04283      -0.009509 0.05850 -0.008187
## 8159 1.431           -0.00317 0.0002854 -0.012720    -0.04194      -0.009797 0.05127 -0.008020
## 8157 1.196                    0.0002864 -0.010430     0.03258      -0.009378 0.05417 -0.006234
## 8158 1.135 5.324e-05          0.0002933 -0.009901     0.04939      -0.009136 0.05850 -0.005905
##      ttl_shr_hrb   TOT_dep log_mdn_toc:TOT_dep slp_dep_vs_tim:TOT_dep df   logLik  AICc delta
## 8160   -0.008667 0.0009934          -0.0003232              6.738e-06 14 -142.559 314.3  0.00
## 8159   -0.008492 0.0010830          -0.0003445              7.357e-06 13 -143.860 314.7  0.45
## 8157   -0.006493 0.0010680          -0.0003590              7.049e-06 12 -144.993 314.8  0.57
## 8158   -0.006119 0.0010190          -0.0003515              6.664e-06 13 -144.601 316.2  1.93
##      weight
## 8160  0.341
## 8159  0.273
## 8157  0.256
...
![](162a2_Currentstatus_NO3_allvars_files/figure-html/unnamed-chunk-25-1.png)<!-- -->![](162a2_Currentstatus_NO3_allvars_files/figure-html/unnamed-chunk-25-2.png)<!-- -->
...
![](162a2_Currentstatus_NO3_allvars_files/figure-html/unnamed-chunk-25-3.png)<!-- -->![](162a2_Currentstatus_NO3_allvars_files/figure-html/unnamed-chunk-25-4.png)<!-- -->

```
## Conditions used in construction of plot
## bare_sparse: 0
## catchment_area: 3.347
## lake_water: 11.96
## log_median_toc: 0.7497363
## slope_dep_vs_time: -13.92201
## tmp: 5.466667
## total_forest: 70.54984
## total_shrub_herbaceous: 3.015
## TOTN_dep: 541.38
## Conditions used in construction of plot
## altitude: 222
## catchment_area: 3.347
