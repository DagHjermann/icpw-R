...
gg_new <- gg +
  labs(x = "Median NO\u2083 concentration 1992-2016 (\u03BCg/L)",
...
gg_new <- gg +
  labs(
    ...
    y = glue("Median {no3} concentration 1992-2016 ({microgram} {per_litre})")
    ) +
  scale_fill_viridis_c("NO\u2083 trend\n(Sen slope, \u03BCg L\u207B\u00B9 yr\u207B\u00B9)")
...
gg_new <- gg +
  labs(
    x = glue("Median TOC concentration 1992-2016 (mg {per_litre})"),
    y = glue("Median TON concentration 1992-2016 ({microgram} {per_litre})")
    ) +
...
gg_new <- gg +
  labs(
    x = glue("Median TOC concentration 1992-2016 (mg {per_litre})"),
    y = glue("Sen slope TOC concentration (mg {per_litre} {per_year})")
    ) +
  scale_fill_viridis_c(glue("TOC/TON trend\n(Sen slope, ratio {per_year})"))
