...
![](162c2_Currentstatus_TOCTON_allvars_files/figure-html/unnamed-chunk-14-1.png)<!-- -->
...
![](162c2_Currentstatus_TOCTON_allvars_files/figure-html/unnamed-chunk-16-1.png)<!-- -->
...
![](162c2_Currentstatus_TOCTON_allvars_files/figure-html/unnamed-chunk-18-1.png)<!-- -->
...
## |   |   [3] altitude <= 494
## |   |   |   [4] slope_dep_vs_time <= -14.46973: 0.953 (n = 7, err = 0.2)
## |   |   |   [5] slope_dep_vs_time > -14.46973: 1.139 (n = 14, err = 0.2)
## |   |   [6] altitude > 494: 0.870 (n = 16, err = 0.4)
## |   [7] log_median_toc > 0.20412
## |   |   [8] log_median_toc <= 0.78691
## |   |   |   [9] lake_water <= 6.219: 1.456 (n = 19, err = 0.2)
## |   |   |   [10] lake_water > 6.219
## |   |   |   |   [11] log_median_toc <= 0.5563
## |   |   |   |   |   [12] slope_dep_vs_time <= -10.21152: 1.212 (n = 19, err = 0.1)
## |   |   |   |   |   [13] slope_dep_vs_time > -10.21152
## |   |   |   |   |   |   [14] log_median_toc <= 0.41497: 1.259 (n = 15, err = 0.1)
## |   |   |   |   |   |   [15] log_median_toc > 0.41497: 1.354 (n = 12, err = 0.0)
## |   |   |   |   [16] log_median_toc > 0.5563
## |   |   |   |   |   [17] log_median_ton <= 2.34242: 1.416 (n = 26, err = 0.1)
## |   |   |   |   |   [18] log_median_ton > 2.34242
## |   |   |   |   |   |   [19] log_median_toc <= 0.67256: 1.251 (n = 8, err = 0.0)
## |   |   |   |   |   |   [20] log_median_toc > 0.67256: 1.329 (n = 14, err = 0.0)
## |   |   [21] log_median_toc > 0.78691
## |   |   |   [22] slope_dep_vs_time <= -18.8471
## |   |   |   |   [23] lake_water <= 5.594: 1.512 (n = 21, err = 0.2)
## |   |   |   |   [24] lake_water > 5.594
## |   |   |   |   |   [25] TOTN_dep <= 1016.67
## |   |   |   |   |   |   [26] cultivated <= 1.043
## |   |   |   |   |   |   |   [27] catchment_area <= 1.519: 1.393 (n = 7, err = 0.0)
## |   |   |   |   |   |   |   [28] catchment_area > 1.519: 1.478 (n = 27, err = 0.1)
## |   |   |   |   |   |   [29] cultivated > 1.043: 1.383 (n = 10, err = 0.0)
## |   |   |   |   |   [30] TOTN_dep > 1016.67: 1.342 (n = 12, err = 0.0)
## |   |   |   [31] slope_dep_vs_time > -18.8471
## |   |   |   |   [32] log_median_toc <= 0.94448
## |   |   |   |   |   [33] log_median_ton <= 2.41747: 1.506 (n = 20, err = 0.0)
## |   |   |   |   |   [34] log_median_ton > 2.41747: 1.415 (n = 8, err = 0.0)
## |   |   |   |   [35] log_median_toc > 0.94448
## |   |   |   |   |   [36] wetland <= 6.50778
## |   |   |   |   |   |   [37] pre <= 1143.70007: 1.522 (n = 15, err = 0.0)
## |   |   |   |   |   |   [38] pre > 1143.70007: 1.606 (n = 16, err = 0.0)
## |   |   |   |   |   [39] wetland > 6.50778: 1.628 (n = 16, err = 0.1)
## 
...
## 
##           Mean of squared residuals: 0.007188409
##                     % Var explained: 82.26
```
...
![](162c2_Currentstatus_TOCTON_allvars_files/figure-html/unnamed-chunk-21-1.png)<!-- -->
...
![](162c2_Currentstatus_TOCTON_allvars_files/figure-html/unnamed-chunk-21-2.png)<!-- -->
...
##      (Int)        alt    bar_spr   ctc_are log_mdn_toc log_mdn_ton       pre       tmp
## 755  2.864            -0.0003368                0.9812     -0.9318 1.317e-05 -0.003768
## 1777 2.821                                      1.0480     -0.9143 1.147e-05 -0.003441
## 1778 2.824 -1.178e-05                           1.0330     -0.9127 1.235e-05 -0.003694
## 754  2.862 -1.488e-05                           0.9841     -0.9308 1.276e-05 -0.003755
## 756  2.862 -8.729e-06 -0.0002703                0.9788     -0.9292 1.350e-05 -0.003890
## 1779 2.839            -0.0002361                1.0150     -0.9208 1.261e-05 -0.003672
## 243  2.874            -0.0003213                0.9850     -0.9381 1.503e-05 -0.004324
## 753  2.867                                      0.9916     -0.9371 1.170e-05 -0.003434
## 1265 2.830                                      1.0510     -0.9200 1.331e-05 -0.003986
## 759  2.862            -0.0003399 7.445e-06      0.9805     -0.9311 1.321e-05 -0.003738
##            urb log_mdn_toc:log_mdn_ton df  logLik    AICc delta weight
## 755  -0.002708                          8 576.605 -1136.7  0.00  0.181
## 1777 -0.002576                -0.02687  8 576.319 -1136.1  0.57  0.136
## 1778 -0.002942                -0.02285  9 577.052 -1135.5  1.23  0.098
## 754  -0.003040                          8 575.956 -1135.4  1.30  0.095
## 756  -0.002953                          9 576.954 -1135.3  1.43  0.089
## 1779 -0.002668                -0.01482  9 576.921 -1135.2  1.49  0.086
## 243                                     7 574.802 -1135.2  1.50  0.086
## 753  -0.002579                          7 574.740 -1135.1  1.62  0.081
## 1265                          -0.02690  7 574.686 -1135.0  1.73  0.076
## 759  -0.002785                          9 576.772 -1134.9  1.79  0.074
...
![](162c2_Currentstatus_TOCTON_allvars_files/figure-html/unnamed-chunk-25-1.png)<!-- -->
