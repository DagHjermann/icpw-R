---
title: "162ab2 Analyse NO3 medians 2012-2016 - not area"
author: "DHJ"
date: "8 5 2020"
output: 
  html_document:
...
![](162ab2_Currentstatus_NO3_allvars_files/figure-html/unnamed-chunk-15-1.png)<!-- -->
...
## -------------------------------------------------------------
## Variables: 
## log_median_no3,log_median_toc,slope_dep_vs_time, TOTN_dep, latitude, longitude, altitude,pre, tmp, urban, cultivated, total_forest, total_shrub_herbaceous,wetland, lake_water, bare_sparse
## -------------------------------------------------------------
...
![](162ab2_Currentstatus_NO3_allvars_files/figure-html/unnamed-chunk-17-1.png)<!-- -->
...
![](162ab2_Currentstatus_NO3_allvars_files/figure-html/unnamed-chunk-19-1.png)<!-- -->
...
## |   |   |   |   [20] lake_water <= 4.661: 2.514 (n = 15, err = 0.6)
## |   |   |   |   [21] lake_water > 4.661: 2.231 (n = 21, err = 0.7)
...
![](162ab2_Currentstatus_NO3_allvars_files/figure-html/unnamed-chunk-20-1.png)<!-- -->
...
## 
##           Mean of squared residuals: 0.2014245
##                     % Var explained: 59.64
```
...
![](162ab2_Currentstatus_NO3_allvars_files/figure-html/unnamed-chunk-22-1.png)<!-- -->
...
![](162ab2_Currentstatus_NO3_allvars_files/figure-html/unnamed-chunk-22-2.png)<!-- -->
...
## 1                TOTN_dep       1.206000        7746  0.312607785            52.162623
## 2       slope_dep_vs_time       1.764000        7934  0.213420253            33.339648
## 3                     tmp       1.874000        6226  0.261461025            29.776189
## 4                altitude       2.446000        7228  0.052345135            16.854834
## 5              lake_water       2.808000        6572  0.033116670            12.141987
## 6          log_median_toc       2.478000        7047  0.083680903            14.241003
## 7            total_forest       3.358000        6260  0.042485348            10.314552
## 8             bare_sparse       3.936408        2850  0.021693317             4.458617
## 9                     pre       3.028000        6062  0.071089096            14.037370
## 10                wetland       3.184000        5327  0.032563642            11.002569
## 11             cultivated       6.642120        1321  0.003199191             1.411361
## 12 total_shrub_herbaceous       3.798000        4997  0.017422475             6.056534
## 13                  urban       4.194816        2189  0.040750813             6.751942
##    no_of_trees times_a_root       p_value
## 1          500          198 5.613993e-192
## 2          500          107 1.454923e-223
## 3          500          101  1.458847e-22
## 4          500           50 1.428849e-116
## 5          500           20  6.466117e-47
## 6          500            7  2.191093e-94
## 7          500            7  1.464033e-24
## 8          498            4  1.000000e+00
## 9          500            4  3.721291e-14
## 10         500            2  9.967600e-01
## 11         470            0  1.000000e+00
## 12         500            0  1.000000e+00
## 13         496            0  1.000000e+00
```
...
![](162ab2_Currentstatus_NO3_allvars_files/figure-html/5c3_plot_partial_effects2-1.png)<!-- -->![](162ab2_Currentstatus_NO3_allvars_files/figure-html/5c3_plot_partial_effects2-2.png)<!-- -->![](162ab2_Currentstatus_NO3_allvars_files/figure-html/5c3_plot_partial_effects2-3.png)<!-- -->![](162ab2_Currentstatus_NO3_allvars_files/figure-html/5c3_plot_partial_effects2-4.png)<!-- -->![](162ab2_Currentstatus_NO3_allvars_files/figure-html/5c3_plot_partial_effects2-5.png)<!-- -->![](162ab2_Currentstatus_NO3_allvars_files/figure-html/5c3_plot_partial_effects2-6.png)<!-- -->![](162ab2_Currentstatus_NO3_allvars_files/figure-html/5c3_plot_partial_effects2-7.png)<!-- -->
...
##      (Int)       alt   bar_spr  lak_wtr log_mdn_toc slp_dep_vs_tim     tmp   ttl_frs
## 4079 1.701           -0.005386 -0.01814    -0.07193       -0.01188 0.04690 -0.010170
## 4080 1.678 0.0001216 -0.006861 -0.01811    -0.07082       -0.01154 0.05647 -0.010240
## 4077 1.313                     -0.01455     0.04079       -0.01094 0.05004 -0.007088
##      ttl_shr_hrb   TOT_dep log_mdn_toc:TOT_dep slp_dep_vs_tim:TOT_dep df   logLik  AICc delta
## 4079   -0.010280 0.0009634          -0.0003714              6.139e-06 12 -348.193 721.1  0.00
## 4080   -0.010330 0.0008352          -0.0003464              5.231e-06 13 -347.399 721.6  0.53
## 4077   -0.007064 0.0009716          -0.0003870              5.893e-06 11 -349.931 722.5  1.36
##      weight
## 4079  0.440
## 4080  0.337
## 4077  0.223
...
![](162ab2_Currentstatus_NO3_allvars_files/figure-html/unnamed-chunk-26-1.png)<!-- -->![](162ab2_Currentstatus_NO3_allvars_files/figure-html/unnamed-chunk-26-2.png)<!-- -->
...
![](162ab2_Currentstatus_NO3_allvars_files/figure-html/unnamed-chunk-26-3.png)<!-- -->

```
## Conditions used in construction of plot
## lake_water: 11.554
## log_median_toc: 0.7242759
