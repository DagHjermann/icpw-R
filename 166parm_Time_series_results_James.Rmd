...
params:
  document_title: 
    value: '166d1x Analyse NO3 decline - test run'
  text_dataset: 
    value: 'Data with slope_dep_vs_time, NO3, and TOTN_dep'
  selected_vars: 
    value: 'slope_no3_vs_time, slope_toc_vs_time, TOC, NO3, slope_dep_vs_time, TOTN_dep, latitude, longitude,slope_pre, pre, slope_tmp, tmp, urban, cultivated, coniferous, decid_mixed, total_shrub_herbaceous,wetland, lake_water, bare_sparse'
  response_variable:
