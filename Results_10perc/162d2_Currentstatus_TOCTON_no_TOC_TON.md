...
![](162d2_Currentstatus_TOCTON_no_TOC_TON_files/figure-html/unnamed-chunk-14-1.png)<!-- -->
...
![](162d2_Currentstatus_TOCTON_no_TOC_TON_files/figure-html/unnamed-chunk-16-1.png)<!-- -->
...
![](162d2_Currentstatus_TOCTON_no_TOC_TON_files/figure-html/unnamed-chunk-18-1.png)<!-- -->
...
## |   |   |   |   |   [11] tmp <= 3.38333: 1.317 (n = 9, err = 0.1)
## |   |   |   |   |   [12] tmp > 3.38333
...
## |   |   |   [17] total_forest <= 42.51769: 1.148 (n = 20, err = 0.5)
## |   |   |   [18] total_forest > 42.51769
## |   |   |   |   [19] TOTN_dep <= 782.53: 1.398 (n = 62, err = 0.7)
## |   |   |   |   [20] TOTN_dep > 782.53
## |   |   |   |   |   [21] pre <= 829.49994: 1.349 (n = 7, err = 0.0)
## |   |   |   |   |   [22] pre > 829.49994: 1.215 (n = 13, err = 0.1)
## |   [23] bare_sparse > 27.834
## |   |   [24] altitude <= 626: 1.143 (n = 10, err = 0.1)
## |   |   [25] altitude > 626: 0.878 (n = 13, err = 0.5)
## 
...
## 
##           Mean of squared residuals: 0.01438722
##                     % Var explained: 64.5
```
...
![](162d2_Currentstatus_TOCTON_no_TOC_TON_files/figure-html/unnamed-chunk-21-1.png)<!-- -->
...
![](162d2_Currentstatus_TOCTON_no_TOC_TON_files/figure-html/unnamed-chunk-21-2.png)<!-- -->
...
##     (Int)        alt   bar_spr   lak_wtr        pre  ttl_frs      urb df  logLik   AICc delta
## 204 1.470 -0.0001854 -0.004091 -0.006666            0.001502 -0.01590  7 171.509 -328.6  0.00
## 220 1.489 -0.0001858 -0.004061 -0.006748 -1.184e-05 0.001432 -0.01601  8 171.779 -327.1  1.57
##     weight
## 204  0.687
## 220  0.313
...
![](162d2_Currentstatus_TOCTON_no_TOC_TON_files/figure-html/unnamed-chunk-25-1.png)<!-- -->
