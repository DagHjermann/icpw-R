...
![](162b2_Currentstatus_NO3_no_TOC_files/figure-html/unnamed-chunk-14-1.png)<!-- -->
...
![](162b2_Currentstatus_NO3_no_TOC_files/figure-html/unnamed-chunk-16-1.png)<!-- -->
...
![](162b2_Currentstatus_NO3_no_TOC_files/figure-html/unnamed-chunk-18-1.png)<!-- -->
...
## |   [2] TOTN_dep <= 710.95
## |   |   [3] tmp <= 8.24167
## |   |   |   [4] slope_dep_vs_time <= -17.36417: 1.530 (n = 53, err = 12.3)
## |   |   |   [5] slope_dep_vs_time > -17.36417
## |   |   |   |   [6] pre <= 1229.80005
## |   |   |   |   |   [7] cultivated <= 0.027: 0.790 (n = 107, err = 37.2)
## |   |   |   |   |   [8] cultivated > 0.027: 1.311 (n = 16, err = 2.6)
## |   |   |   |   [9] pre > 1229.80005
## |   |   |   |   |   [10] slope_dep_vs_time <= -7.73529
## |   |   |   |   |   |   [11] bare_sparse <= 0.404
## |   |   |   |   |   |   |   [12] pre <= 1499
## |   |   |   |   |   |   |   |   [13] total_shrub_herbaceous <= 8.66929: 1.303 (n = 37, err = 0.0)
## |   |   |   |   |   |   |   |   [14] total_shrub_herbaceous > 8.66929: 1.300 (n = 7, err = 0.0)
## |   |   |   |   |   |   |   [15] pre > 1499: 1.257 (n = 8, err = 0.1)
## |   |   |   |   |   |   [16] bare_sparse > 0.404: 1.555 (n = 7, err = 0.4)
## |   |   |   |   |   [17] slope_dep_vs_time > -7.73529
## |   |   |   |   |   |   [18] lake_water <= 8.504: 0.816 (n = 7, err = 0.3)
## |   |   |   |   |   |   [19] lake_water > 8.504: 1.223 (n = 24, err = 1.1)
## |   |   [20] tmp > 8.24167: 2.369 (n = 8, err = 0.1)
## |   [21] TOTN_dep > 710.95
## |   |   [22] bare_sparse <= 4.895: 1.855 (n = 157, err = 62.9)
## |   |   [23] bare_sparse > 4.895
## |   |   |   [24] lake_water <= 2.836: 2.608 (n = 8, err = 0.1)
## |   |   |   [25] lake_water > 2.836
## |   |   |   |   [26] bare_sparse <= 47.412: 2.107 (n = 12, err = 0.5)
## |   |   |   |   [27] bare_sparse > 47.412: 2.373 (n = 11, err = 0.1)
## 
...
## 
##           Mean of squared residuals: 0.1996988
##                     % Var explained: 59.48
```
...
![](162b2_Currentstatus_NO3_no_TOC_files/figure-html/unnamed-chunk-21-1.png)<!-- -->
...
![](162b2_Currentstatus_NO3_no_TOC_files/figure-html/unnamed-chunk-21-2.png)<!-- -->
...
## 1014 1.317 0.0001421           -0.01495                 -0.01211 0.05022 -0.007631   -0.006666
## 1016 1.499 0.0001964 -0.003426 -0.01668                 -0.01240 0.04953 -0.009686   -0.008497
## 1013 1.484                     -0.01626                 -0.01312 0.03438 -0.009045   -0.007836
## 1022 1.285 0.0001301           -0.01492 4.083e-05       -0.01213 0.04590 -0.007594   -0.006856
##        TOT_dep slp_dep_vs_tim:TOT_dep df   logLik  AICc delta weight
## 1014 0.0006916              6.554e-06 10 -366.051 752.6  0.00  0.360
## 1016 0.0006676              6.423e-06 11 -365.312 753.2  0.62  0.264
## 1013 0.0008363              7.920e-06  9 -367.578 753.6  0.96  0.222
## 1022 0.0007151              6.687e-06 11 -365.843 754.3  1.68  0.155
...
![](162b2_Currentstatus_NO3_no_TOC_files/figure-html/unnamed-chunk-25-1.png)<!-- -->
...
![](162b2_Currentstatus_NO3_no_TOC_files/figure-html/unnamed-chunk-25-2.png)<!-- -->

```
## Conditions used in construction of plot
## lake_water: 11.867
## slope_dep_vs_time: -15.67144
## tmp: 5.458334
## total_forest: 72.6965
